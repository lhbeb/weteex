...
const ADDRESS_CONFIGS: Record<string, AddressConfig> = {
  ...
  DE: {
    ...
    streetPlaceholder: 'z.B. Hohenstaufenring 78',
    line2Label: 'Wohnung, Etage oder Zusatz (optional)',
    cityLabel: 'Stadt *',
    stateLabel: 'Bundesland *',
    statePlaceholder: 'Bundesland auswählen oder eingeben',
    zipLabel: 'Postleitzahl *',
    zipPlaceholder: 'z.B. 50674',
    zipPattern: '\\d{5}',
    zipTitle: 'Bitte geben Sie eine 5-stellige deutsche Postleitzahl ein',
    zipMaxLength: 5,
    zipInputMode: 'numeric',
...
export function usesCountryFirstAddress(checkoutFlow?: string | null): boolean {
  return checkoutFlow === 'stripe' || checkoutFlow === 'kofi' || isPaypalCheckoutFlow(checkoutFlow);
}
