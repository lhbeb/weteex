  ...
  try {
    ...
    const emailContent = `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
        <h2 style="color: #01428a; border-bottom: 2px solid #01428a; padding-bottom: 10px;">
        ...
        <div style="background-color: #f8f9fa; padding: 20px; border-radius: 8px; margin: 20px 0;">
          ...
          <div style="background-color: white; padding: 15px; border-left: 4px solid #01428a; margin: 10px 0;">
            "${content}"
          </div>
        </div>

        <div style="background-color: #e8f4fd; padding: 15px; border-radius: 8px; margin: 20px 0;">
          <h4 style="color: #01428a; margin-top: 0;">Submission Information:</h4>
          <ul style="list-style: none; padding: 0;">
